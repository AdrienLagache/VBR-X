  ...
  return (
    <section className="historic">
      ...
      <p className="historic-content">
        ...
        Président de la NLE de 1987 à 2003 et "entre autre" Multiple Recordman
        Mondial sur GT & F1 & TOCA 1/2 de 1997 à 2002)... et qui l'a développée
        dés Octobre 2017. En Parallèle l'Association Virtual Best Racing à
        absorbée plusieurs Teams eRacing telles que ( NLE, DDRX, IST, etc ... ).
      </p>
      <ul className="historic-list">
        <li className="historic-list__item">
          Elle est Aujourd'hui spécialisée" exclusivement dans la simulation
          automobile" sur PC, PS4 et Xbox. Nous sommes une équipe Française
          basée a Alès dans la région d'Occitanie.
        </li>
        <li className="historic-list__item">
          Son Statut Officiel d'Association a été créé en Juillet 2018 par le
          Président actuel VBR AutumnFuel.
        </li>
        <li className="historic-list__item">
        ...
        <li className="historic-list__item">
          Nous favorisons, formons et assistons nos pilotes afin qu'ils puissent
          ...
          RBR (Richard Burns Rally), et ses multiples titres Nationaux &
          Mondiaux de champions et Vice champions individuels sur PC et consoles
          PS4 et Xbox. Nous sommes également connus pour notre présence
          régulière à haut niveau sur les séries DIRT.
        </li>
        <li className="historic-list__item">
          ...
          d'une équipe composée de "copains" qui partagent le même état
          d'esprit. Notre objectif est d'aller tutoyer les sommets dans le monde
          du Esport.
        </li>
        <li className="historic-list__item">
